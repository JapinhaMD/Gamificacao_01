...
namespace JRJ.Modas
{
    ...
    public class ClientesUI
    {
        ...
        private void CadastrarCliente()
        {
            ...
            var proximoID = Program.clientes.Max((e) => e.ClienteID) + 1;
        ...
        private void AlterarCliente()
        {
            ...
            ClienteModel cliente = Program.clientes.Find(c => c.ClienteID == id);
        ...
        private void ExcluirCliente()
        {
            ...
            if (cliente != null)
            {
                Program.clientes.Remove(cliente);
        ...
        static ClienteModel SelecionarCliente()
        {
            Console.Clear();
            ...
            {
                return Program.clientes.Find(c => c.ClienteID == idCliente);
            }
        }
    }
}